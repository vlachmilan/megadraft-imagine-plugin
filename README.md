# megadraft imagine plugin - Megadraft Plugin

Inspired by:

* https://github.com/lilnamcor/megadraft-image-plugin
* https://github.com/michelson/dante2

Consider checking out these projects.
...
import plugin from "megadraft-imagine-plugin";
